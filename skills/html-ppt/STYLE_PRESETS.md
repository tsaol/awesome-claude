...
Curated visual styles for html-ppt. Each preset has exact fonts, colors, and signature elements — no generic "AI slop" aesthetics. **Abstract shapes only — no illustrations.**

**Viewport CSS:** Always include [viewport-base.css](viewport-base.css) in every presentation.
...
Use this when user picks a mood in the "show me options" flow:

| Mood | Suggested Presets (pick 3) |
|------|---------------------------|
...
**Fonts:** Inter, Roboto, Arial, system fonts as display (system fonts OK for Amazon Brand only)
