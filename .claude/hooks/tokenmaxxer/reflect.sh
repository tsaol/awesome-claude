...
{
  "hookSpecificOutput": {
    "additionalContext": "Self-reflect: You just modified ${FILE_PATH}. Does this change have test coverage? Did you handle edge cases? Could this introduce a regression? If something is missing, address it now before moving on."
  }
}
EOF
    fi
